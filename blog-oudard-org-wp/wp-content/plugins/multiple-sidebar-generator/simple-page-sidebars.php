...
class Simple_Page_Sidebars {
	...
	public static function upgrade() {
		...
		// If the plugin version setting isn't set or if it's less than or equal to 2.1.1, update the saved version.
		if ( ! $saved_version || version_compare( $saved_version, '2.1.1', '<=' ) ) {
